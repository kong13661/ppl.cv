...
__kernel void cropU8Kernel(global const uchar* src, int src_stride,
                           const int top, const int left, const float scale,
                           global uchar* dst, int dst_rows, int dst_cols,
                           int dst_stride) {
...
__kernel void cropF32Kernel(global const float* src, int src_stride,
                           const int top, const int left, const float scale,
                           global float* dst, int dst_rows, int dst_cols,
                           int dst_stride) {
